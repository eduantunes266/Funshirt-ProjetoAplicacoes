...
<div>
    ...
    <textarea id="description" name="description" rows="3"
              class="mt-1 block w-full border-gray-300 focus:border-indigo-500 focus:ring-indigo-500 rounded-md shadow-sm">{{ old('description', $tshirt?->description) }}</textarea>
    ...
    @if ($tshirt && $tshirt->image_url)
        <div class="mb-2">
            <img src="{{ asset('storage/tshirt_images/' . $tshirt->image_url) }}"
                 alt="Imagem atual"
                 class="h-32 w-32 object-contain border border-gray-200 rounded bg-gray-50">
        </div>
    @endif
